            ...
            for (var c = 0; c < arguments.length; c++) {
                ...
                if (arguments[c] !== undefined && arguments[c] !== null) {
                    for (d in arguments[c]) {
                        if (typeof arguments[c][d] == "object" && !(arguments[c][d] instanceof Number) && !(arguments[c][d] instanceof Date) && !(arguments[c][d] instanceof String) && !(arguments[c][d] instanceof Array) && b[d] !== undefined) {
...
var ValidationM3 = function() {
    this.isM3Chart = function(a) {
        return this.isCartesianChart(a) || this.isPolarChart(a);
    };
    this.isDataViz = function(a) {
        return a instanceof M3.DataViz;
    };
    this.isCartesianChart = function(a) {
        return this.isDataViz(a) && a instanceof M3.Chart;
    };
    this.isPolarChart = function(a) {
        return this.isDataViz(a) && a instanceof M3.AbstractPolarChart;
    };
};
...
(function() {
    ...
    M3.DataViz.prototype.setConfig = function(a) {
        ...
        var c = M3.extend(b, a !== undefined ? a : {});
        var d = [ "width", "height" ];
        var e = [ 200, 100 ];
        d.forEach(function(a, b) {
            if (c[a] === undefined || c[a] === null || isNaN(c[a])) {
                var d = d3.select(c.container);
                var f = d;
                if (f.length > 0) {
                    f = f[0];
                }
                ...
                if (f !== undefined && f !== null) {
                    c[a] = f["client" + a.charAt(0).toUpperCase() + a.substring(1)];
                    var g = null;
                    if (a == "width") {
                        g = d.style("padding-right");
                        var h = g.substring(0, g.length - 2);
                        g = d.style("padding-left");
                        var i = g.substring(0, g.length - 2);
                        c[a] -= +h;
                        c[a] -= +i;
                    } else {
                        g = d.style("padding-top");
                        var j = g.substring(0, g.length - 2);
                        g = d.style("padding-bottom");
                        var k = g.substring(0, g.length - 2);
                        c[a] -= +j;
                        c[a] -= +k;
                    }
                }
                if (c[a] === undefined || c[a] === null || isNaN(c[a]) || +c[a] <= 0) {
                    c[a] = e[b];
                }
            }
        });
        if (c.margin.all !== undefined && c.margin.all !== null && !isNaN(c.margin.all)) {
    ...
    M3.DataViz.prototype.resize = function(a, b) {
        if (a === undefined || a === null || isNaN(a)) {
            var c = d3.select(this.config.container);
            var d = c;
            if (d.length > 0) {
                d = d[0];
            }
        ...
        d3.select(this.config.container + " ." + this.config.styles.container).attr("width", this.config.width).attr("height", this.config.height);
        d3.select(this.config.container + " ." + this.config.styles.container + " > rect").attr("width", this.config.width).attr("height", this.config.height);
        d3.select(this.config.container + " ." + this.config.styles.container + " ." + this.config.styles.canvas).attr("width", this.config.canvasWidth).attr("height", this.config.canvasHeight);
        d3.select(this.config.container + " ." + this.config.styles.container + " ." + this.config.styles.canvas + " > rect").attr("width", this.config.canvasWidth).attr("height", this.config.canvasHeight);
    };
})();
...
(function() {
    ...
    M3.AbstractChart.prototype.setConfig = function(a) {
        ...
        var e = a !== undefined && a !== null ? M3.mixin(a, d) : d;
        M3.DataViz.prototype.setConfig.call(this, e);
        return this;
    };
    M3.AbstractChart.prototype.resize = function(a, b) {
        M3.DataViz.prototype.resize.call(this, [ a, b ]);
    };
})();
...
(function() {
    ...
    M3.Axis.AxisItem.prototype.resize = function(a, b, c, d) {
        this._w = a;
        this._h = b;
        this.getAxis();
        if (this._config.show) {
            this.axisSVG.attr("transform", "translate(" + c + ", " + d + ")").call(this.axis.orient(this._config.pos));
        }
        return this;
    };
})();
...
(function() {
    ...
    M3.Axis.CategoryAxis.prototype.getAxisScale = function(a) {
        ...
        if (this.scale == null) {
            ...
            this.scale.rangeRoundBands(a, this._config.padding, this._config.outterPadding);
        }
        return this.scale;
    };
...
(function() {
    ...
    M3.Axis.CategoryPointsAxis.prototype.getAxisScale = function(a) {
        ...
        if (this.scale == null) {
            ...
            this.scale.rangePoints(a, this._config.padding);
        }
        return this.scale;
    };
})();
...
(function() {
    ...
    M3.Axis.AxisManager.prototype.resize = function(a) {
        this.setConfig(a);
        if (this.axis.left !== null) {
            this.drawLeftAxis(this.axis.left, true);
        }
        if (this.axis.bottom !== null) {
            this.drawBottomAxis(this.axis.bottom, true);
        }
        if (this.axis.right !== null) {
            this.drawRightxis(this.axis.right, true);
        }
        if (this.axis.top !== null) {
            this.drawTopAxis(this.axis.top, true);
        }
    };
    M3.Axis.AxisManager.prototype.drawRightxis = function(a, b) {
        var c = this.config.canvasWidth - this.getOffset("right");
        var d = this.getOffset("top");
        var e = a.conf.width;
        var f = this.config.canvasHeight - this.getOffset("top") - this.getOffset("bottom");
        var g = d3.select(this.config.container + " .canvas");
        var h = M3, i = 0;
        var j = a.conf.clazz.split(".");
        while (i < j.length) {
            h = h[j[i++]];
        }
        if (b === true) {
            a.axis.resize(e, f, c, d);
        } else {
            a.axis = new h().canvas(g).config(a.conf).data(this.data).draw(e, f, c, d);
        }
    };
    M3.Axis.AxisManager.prototype.drawLeftAxis = function(a, b) {
    ...
    M3.Axis.AxisManager.prototype.drawBottomAxis = function(a, b) {
        var c = this.getOffset("left");
        var d = this.config.canvasHeight - this.getOffset("bottom");
        var e = this.config.canvasWidth - this.getOffset("left") - this.getOffset("right");
        var f = a.conf.width;
        var g = d3.select(this.config.container + " .canvas");
        var h = M3, i = 0;
        var j = a.conf.clazz.split(".");
    ...
    M3.Axis.AxisManager.prototype.drawTopAxis = function(a, b) {
        var c = this.getOffset("left");
        var d = a.conf.width + (a.conf.labelPosition == "outer" && a.conf.label !== "" ? a.conf.labelWidth : 0);
        var e = this.config.canvasWidth - this.getOffset("left") - this.getOffset("right");
        var f = a.conf.width;
        var g = d3.select(this.config.container + " .canvas");
        var h = M3, i = 0;
...
(function() {
    ...
    M3.Series.ColumnSerie.prototype.draw = function(a, b, c, d, e) {
        ...
        var h = d.selectAll(".column");
        var i = null;
        if (h[0].length == 0) {
            i = d.selectAll(".column").data(a).enter().append("g").attr("class", "rect");
            h = i.append("rect");
        }
        var j = c.axis[f.y].axis.scale;
        var k = c.axis[f.x].axis.scale;
        h.attr("class", "column serie s" + e).attr("x", function(a) {
            return k(a[f.itemLabel]);
        }).attr("y", function(a) {
            return j(a[f.itemValue]);
        }).attr("height", function(a) {
            if (f.itemValueMin !== undefined && a[f.itemValueMin] !== undefined && a[f.itemValueMin] !== null) {
                return g - j(a[f.itemValue] - a[f.itemValueMin]);
            } else {
                return g - j(a[f.itemValue]);
            }
...
(function() {
    ...
    M3.Chart.prototype.drawSeries = function() {
        ...
        for (var d = 0; d < b.length; d++) {
            ...
            if (e !== undefined && e !== null && e.clazz !== undefined && e.clazz !== null) {
                ...
                this.series[d] = new g();
                c = this.series[d].draw(this.data, e, this.axis, a, c);
            }
        }
    };
    ...
    M3.Chart.prototype.drawChartArea = function() {
        ...
        var f = null;
        try {
            f = d3.select(this.config.container + " ." + this.config.styles.container + " .chartarea > rect");
            if (f === undefined || f === null) {
                throw new Error();
            }
            var g = f[0][0];
            ...
            f = a.append("g").attr("class", "chartarea").attr("transform", "translate(" + b + ", " + c + ")").append("rect").attr("class", "background");
        }
        f.attr("width", d).attr("height", e);
        return this;
    };
    M3.Chart.prototype.resize = function(a, b) {
        M3.AbstractChart.prototype.resize.call(this, [ a, b ]);
        this.axis.resize(this.config);
        this.drawChartArea();
        var c = d3.select(this.config.container + " .chartarea");
        var d = null;
        if (this.config.series === undefined || this.config.series === null) {
            d = [ this.configSerie({}) ];
        } else if (!(this.config.series instanceof Array)) {
            d = [ this.configSerie(this.config.series) ];
        } else {
            d = this.config.series;
        }
        var e = 1;
        var f = this;
        this.series.forEach(function(a, b) {
            var g = f.configSerie(d[b]);
            e = a.draw(f.data, g, f.axis, c, e);
        });
    };
})();
...
(function() {
    ...
    M3.AbstractPolarChart.prototype.resize = function(a, b) {
        M3.AbstractChart.prototype.resize.call(this, [ a, b ]);
    };
})();
    ...
    var a = function() {
        ...
        this.resize = function() {
            a.forEach(function(a, b, c) {
                if (a["resize"] !== undefined && a["resize"] !== null) {
                    a.resize();
                }
            });
        };
    };
    M3.behaviours.Responsive = function(b) {
        if (this.initialize === undefined || this.initialize === null) {
            this.initialize = true;
            this.resizeImpl = new a();
            this.run = function(a) {
                console.log("Responsive running");
                this.resizeImpl.add(a);
            };
