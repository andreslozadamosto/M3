(function() {
    ...
    var w = d3.select("#axis1")[0][0].clientWidth;
    var h = d3.select("#axis1")[0][0].clientHeight;
    h = (h==0)?198:0;
    ...
    columnChart.behaviours = [new M3.behaviours.Tooltip(), new M3.behaviours.Responsive()];
    columnChart.draw(data2, M3.extend({}, configColumn, {container:"#axis1", responsive:true}));
    /*$(window).on("resize", function() {
        var w = d3.select("#axis1")[0][0].clientWidth;
        var h = d3.select("#axis1")[0][0].clientHeight;
        var aspect = w / h;
        d3.select("#axis1 .m3").attr("width", w);
        d3.select("#axis1 .m3").attr("height", Math.round(w / aspect));
        columnChart.redraw();
    })*/
