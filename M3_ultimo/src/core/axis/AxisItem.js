(function() {
    ...
    */
    M3.Axis.AxisItem.prototype.defaultConfig = function () {
        return {
            pos: "",
            label: "",
            labelPosition: "outer",
    ...
    <table>
        ...
        <tbody>
            ...
            <tr><td>innerTickSize</td><td>Yes</td><td>6 (d3 defaul)</td><td>The size of de line of each tick on the axis (default: 6).</td></tr>
            <tr><td>outerTickSize</td><td>Yes</td><td>6 (d3 defaul)</td><td>The size of de line of each tick on the axis (default: 6).</td></tr>
            ...
            <tr><td>tickValues</td><td></td><td></td><td></td></tr>
        </tbdoy>
    </table>
    ...
    */
    M3.Axis.AxisItem.prototype.config = function(value) {
        this._config = M3.extend({}, this._config, value);
        if(["left", "right", "bottom", "top"].indexOf(this._config.pos) < 0) {
            throw new Error("Axis - Bad Configuration: No pos property was defined");
        }
        this._config.axis = (this._config.pos == "left" || this._config.pos == "right") ? "y" : "x";
        return this;
    };
    ...
    */
    M3.Axis.AxisItem.prototype.getAxis = function() {
        ...
        if(!this.axis) {
            ...
            this.axis.scale(scope.getScale());
        }
        //if(this._config.tickFormat) { this.axis.tickFormat(this._config.tickFormat); }
        if(this._config.tickFormat) { this.axis.tickFormat(this._config.tickFormat); }
        //if(!isNaN(this._config.tickSize)) { this.axis.innerTickSize(this._config.tickSize); }
        if(!isNaN(this._config.innerTickSize)) { this.axis.innerTickSize(this._config.innerTickSize); }
        if(!isNaN(this._config.outerTickSize)) { this.axis.outerTickSize(this._config.outerTickSize); }
        if(!isNaN(this._config.tickPadding)) { this.axis.tickPadding(this._config.tickPadding); }
        if(this._config.tickValues) { this.axis.tickValues(this._config.tickValues); }
    ...
    */
    M3.Axis.AxisItem.prototype.addRect = function(elem, w, h) {
        return elem.insert("rect", "g")
            ...
            .attr("width", w)
            .attr("height", h)
            .attr("transform", "translate(" + ((this._config.axis == "y" && this._config.pos == "left")?(w * -1):0) + ", " + ((this._config.axis == "x" && this._config.pos == "top")?(h*-1):0) + ")");
    };
    ...
    */
    M3.Axis.AxisItem.prototype.addLabel = function(elem) {
        if(this._config.labelPosition != "none" && this._config.label != "") {
    ...
    */
    ...
    M3.Axis.AxisItem.prototype.afterAddAxis = function () {
    }
    
    
    
    M3.Axis.AxisItem.prototype.resize = function(w, h, x, y) {
        this._w = w;
        this._h = h;
        this.getAxis();
        ...
        if(this._config.show) {
            this.axisSVG
                .attr("transform", "translate(" + x + ", " + y + ")")
                .call(this.axis.orient(this._config.pos));
            //d3.select(this._config.axis + " axis " + this._config.axis + this._config.pos).call(this.axis.orient(this._config.pos));
            this.axisSVG.select("text.label").remove();
            this.axisSVG.select("rect.background").remove();
            this.addRect(this.axisSVG, w, h);
            this.addLabel(this.axisSVG);
        }
        return this;
